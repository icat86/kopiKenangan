...
void drawCashRegister() {
    glPushMatrix();
    glColor3f(0.8, 0.8, 0.8);  // Warna abu-abu
    glScalef(30, 15, 40);      // Ukuran mesin kasir
    glutSolidCube(1.0);
    glPopMatrix();

    glPushMatrix();
    glColor3f(0.0, 0.5, 0.5);  // Warna layar
    glTranslatef(-8, 8, 0);   // Posisi layar
    glScalef(20, 10, 40);       // Ukuran layar
    glutSolidCube(1.1);
    glPopMatrix();
}
...
void drawCoffeeMachine() {
    glPushMatrix();
    glColor3f(0.3, 0.3, 0.3);  // Warna mesin kopi
    glScalef(20, 30, 20);      // Ukuran mesin kopi
    glutSolidCube(1.0);
    glPopMatrix();

    glPushMatrix();
    glColor3f(0.7, 0.7, 0.7);  // Warna bagian atas
    glTranslatef(0, 15, 0);    // Posisi bagian atas
    glScalef(20, 10, 20);      // Ukuran bagian atas
    glutSolidCube(1.1);
    glPopMatrix();
}
...
void interior(){
    ...
    // Mesin kopi 1
    glPushMatrix();
    glTranslatef(-10, 5, -320);
    drawCoffeeMachine();
    glPopMatrix();

    // Mesin kopi 2
    glPushMatrix();
    glTranslatef(-10, 5, -350);
    drawCoffeeMachine();
    glPopMatrix();

    // Mesin kopi 3
    glPushMatrix();
    glTranslatef(-10, 5, -290);
    drawCoffeeMachine();
    glPopMatrix();
    ...
    //tv
    glColor3f(0.0, 0.0, 0.0);
    cylinder(20.0f, 175.0f, -180.0f, 1.1f, 50.0f, 10);
    cylinder(20.0f, 175.0f, -230.0f, 1.1f, 50.0f, 10);
    cylinder(20.0f, 175.0f, -280.0f, 1.1f, 50.0f, 10);

    glBegin(GL_QUADS);
    glColor3f(0.0, 0.0, 0.0);
    glVertex3f(28, 120.0, -310.0);
    glVertex3f(28, 120.0, -150.0);
    glVertex3f(16, 160.0, -150.0);
    glVertex3f(16, 160.0, -310.0);
    glEnd();

    //tv1
    glBegin(GL_QUADS);
    glColor3f(0.53, 0.19, 0.13);
    glVertex3f(26, 122.0, -308.0);
    glVertex3f(26, 122.0, -252.0);
    glColor3f(0.78, 0.71, 0.32);
    glVertex3f(16, 158.0, -252.0);
    glVertex3f(16, 158.0, -308.0);
    glEnd();

    //tv2
    glBegin(GL_QUADS);
    glColor3f(0.18, 0.55, 0.65);
    glVertex3f(26, 122.0, -248.0);
    glVertex3f(26, 122.0, -202.0);
    glColor3f(0.8, 0.8, 0.8);
    glVertex3f(16, 158.0, -202.0);
    glVertex3f(16, 158.0, -248.0);
    glEnd();

    //tv3
    glBegin(GL_QUADS);
    glColor3f(0.22, 0.16, 0.05);
    glVertex3f(26, 122.0, -198.0);
    glVertex3f(26, 122.0, -152.0);
    glColor3f(0.66, 0, 0);
    glVertex3f(16, 158.0, -152.0);
    glVertex3f(16, 158.0, -198.0);
    glEnd();


    //lemari koleksi
    glColor3f(0.0, 0.0, 0.0);
    cylinder(-193.0f, 0.0f, -420.0f, 1.5f, 165.0f, 10);
    cylinder(-193.0f, 0.0f, -680.0f, 1.5f, 165.0f, 10);
    cylinder(-145.0f, 0.0f, -420.0f, 1.5f, 165.0f, 10);
    cylinder(-145.0f, 0.0f, -680.0f, 1.5f, 165.0f, 10);
    cylinder(-145.0f, 20.0f, -550.0f, 1.0f, 125.0f, 10);
    cylinder(-190.0f, 20.0f, -550.0f, 1.0f, 125.0f, 10);

    //kotak atas lemari
    glPushMatrix();
    glColor3f(0.0, 0.0, 0.0);
    glTranslatef(-168, 95, -550);
    kotak(52, 30, 262);
    glPopMatrix();
    glEnd();
    ...
    //kotak bawah lemari
    glPushMatrix();
    glColor3f(0.11, 0.08, 0.07);
    glTranslatef(-168, -68, -550);
    kotak(52, 50, 262);
    glPopMatrix();
    glEnd();
    ...
    //tengah-bawah
    glPushMatrix();
    glColor3f(0.18, 0.15, 0.12);
    glTranslatef(-168, -42.5, -550);
    kotak(52, 1, 262);
    glPopMatrix();
    glEnd();
    ...
    //dibawah kiri
    glPushMatrix();
    glColor3f(0.97, 0.62, 0.62);
    glTranslatef(-168, -25, -480);
    kotak(10, 35, 14);
    glPopMatrix();
    glEnd();
    ...
    //3 diatas
    glPushMatrix();
    glColor3f(0.22, 0.05, 0.05);
    glTranslatef(-168, 52.5, -495);
    kotak(10, 25, 14);
    glPopMatrix();
    glEnd();

    glPushMatrix();
    glColor3f(0.22, 0.05, 0.15);
    glTranslatef(-168, 52.5, -480);
    kotak(10, 25, 14);
    glPopMatrix();
    glEnd();

    glPushMatrix();
    glColor3f(0.11, 0.05, 0.22);
    glTranslatef(-168, 52.5, -465);
    kotak(10, 25, 14);
    glPopMatrix();
    glEnd();
    ...
    //jejeran di kanan
    glPushMatrix();
    glColor3f(1, 0.99, 0.56);
    glTranslatef(-168, 5, -630);
    kotak(10, 20, 15);
    glPopMatrix();
    glEnd();

    glPushMatrix();
    glColor3f(0.85, 0.83, 0.25);
    glTranslatef(-168, 5, -600);
    kotak(10, 20, 15);
    glPopMatrix();
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.0, 0.0, 0.0);
    glVertex3f(-29.0, -100.0, -1150.0);
    glVertex3f(-29.0, -100.0, -1280.0);
    glVertex3f(-29.0, 100.0, -1280.0);
    glVertex3f(-29.0, 100.0, -1150.0);
    glEnd();
...
void bangunan_utama() {
    ...
    glVertex3f(-200.0, -100.0, -2502.0);
    glVertex3f(200.0, -100.0, -2502.0);
    glVertex3f(200.0, 1000.0, -2502.0);
    glVertex3f(-200.0, 1000.0, -2502.0);
    glEnd();

    // Left face
    glBegin(GL_QUADS);
    glVertex3f(-201.0, -100.0, -2500.0);
    glVertex3f(-201.0, -100.0, 100.0);
    glVertex3f(-201.0, 1000.0, 100.0);
    glVertex3f(-201.0, 1000.0, -2500.0);
    glEnd();
    ...
    //walpaper abu-abu dalam
    // Back face
    glBegin(GL_QUADS);
    glColor3f(0.16, 0.18, 0.18);
    glVertex3f(-200.0, -100.0, -2499.5);
    glVertex3f(200.0, -100.0, -2499.5);
    glVertex3f(200.0, 15.0, -2499.5);
    glVertex3f(-200.0, 15.0, -2499.5);
    glEnd();

    // Left face
    glBegin(GL_QUADS);
    glVertex3f(-199.0, -100.0, -2500.0);
    glVertex3f(-199.0, -100.0, -50.0);
    glVertex3f(-199.0, 15.0, -50.0);
    glVertex3f(-199.0, 15.0, -2500.0);
    glEnd();

    // depan dapur
    glBegin(GL_QUADS);
    glColor3f(0.16, 0.18, 0.18);
    glVertex3f(-28.0, -100.0, -551.5);
    glVertex3f(200.0, -100.0, -551.5);
    glVertex3f(200.0, 15.0, -551.5);
    glVertex3f(-28.0, 15.0, -551.5);
    glEnd();

    //samping dapur
    glBegin(GL_QUADS);
    glVertex3f(-28.0, -100.0, -1325.0);
    glVertex3f(-28.0, -100.0, -550.0);
    glVertex3f(-28.0, 15.0, -550.0);
    glVertex3f(-28.0, 15.0, -1325.0);
    glEnd();

    // Right face 1
    glBegin(GL_QUADS);
    glVertex3f(199.0, -100.0, -600.0);
    glVertex3f(199.0, -100.0, -50.0);
    glVertex3f(199.0, 15.0, -50.0);
    glVertex3f(199.0, 15.0, -600.0);
    glEnd();

    // Right face 2
    glBegin(GL_QUADS);
    glVertex3f(199.0, -100.0, -2500.0);
    glVertex3f(199.0, -100.0, -1500.0);
    glVertex3f(199.0, 15.0, -1500.0);
    glVertex3f(199.0, 15.0, -2500.0);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.16, 0.18, 0.18);
    glVertex3f(-199.0, 201.0, -2500.0);
    glVertex3f(-199.0, 201.0, 100.0);
    glVertex3f(-199.0, 315.0, 100.0);
    glVertex3f(-199.0, 315.0, -2500.0);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.16, 0.18, 0.18);
    glVertex3f(-200.0, 201.0, -2099.5);
    glVertex3f(0.0, 201.0, -2099.5);
    glVertex3f(0.0, 315.0, -2099.5);
    glVertex3f(-200.0, 315.0, -2099.5);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.16, 0.18, 0.18);
    glVertex3f(0.0, 201.0, -1999.2);
    glVertex3f(200.0, 201.0, -1999.2);
    glVertex3f(200.0, 315.0, -1999.2);
    glVertex3f(0.0, 315.0, -1999.2);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.16, 0.18, 0.18);
    glVertex3f(-0.2, 201.0, -1999.5);
    glVertex3f(-0.2, 201.0, -2099.5);
    glVertex3f(-0.2, 315.0, -2099.5);
    glVertex3f(-0.2, 315.0, -1999.5);
    glEnd();


    //glColor3f(0.16, 0.18, 0.18);              //abu-abu
    //glColor3f(0.64, 0.57, 0.49);              //caramel
